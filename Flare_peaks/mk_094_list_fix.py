"""
    Code to 
    	1. produce a list of AIA 094 flares based on GOES flare times 
...
###########################################################################
#mk_AIA_094
#This program searches a directory for AIA_094 sub-directories.  If none are 
#  found, the code:
#	1. Creates an AIA 094 sub directory
#	2. Finds HEK flare events in 094 around the GOES event
...
#Query the HEK for AIA 094 files
...
#For each sub-directory, initiate a thread to search for AIA_094 entries
#Create the multi-processing pool
po=mp.Pool(n_threads)
for  directory in GOES_dirs:
	print('Here2a')
	mk_AIA_094(directory)
