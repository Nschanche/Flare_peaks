"""
    Code to 
    	1. produce a list of AIA 211 flares based on GOES flare times 
...
###########################################################################
#mk_AIA_211
#This program searches a directory for AIA_211 sub-directories.  If none are 
#  found, the code:
#	1. Creates an AIA 211 sub directory
#	2. Finds HEK flare events in 211 around the GOES event
...
#Query the HEK for AIA 211 files
...
#For each sub-directory, initiate a thread to search for AIA_211 entries
#Create the multi-processing pool
po=mp.Pool(n_threads)
for  directory in GOES_dirs:
	print('Here2a')
	mk_AIA_211(directory)
