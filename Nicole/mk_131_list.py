"""
    Code to 
    	1. produce a list of AIA 131 flares based on GOES flare times 
...
top_level_dir="/home/hwinter/programs/Nicole/"
...
###########################################################################
#mk_AIA_131
#This program searches a directory for AIA_131 sub-directories.  If none are 
#  found, the code:
#	1. Creates an AIA 131 sub directory
#	2. Finds HEK flare events in 131 around the GOES event
...
#Query the HEK for AIA 131 files
...
#For each sub-directory, initiate a thread to search for AIA_131 entries
#Create the multi-processing pool
po=mp.Pool(n_threads)
for  directory in GOES_dirs:
	print('Here2a')
	mk_AIA_131(directory)
